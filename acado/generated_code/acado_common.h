 ...
 * 
 *  Matrix containing 100 reference/measurement vectors of size 14 for first 100 nodes.
 */
real_t y[ 1400 ];
...
/** Matrix of size: 1400 x 14 (row major format) */
real_t W[ 19600 ];
...
/** Matrix of size: 1000 x 4 (row major format) */
real_t evGu[ 4000 ];
...
/** Matrix of size: 1000 x 14 (row major format) */
real_t Q2[ 14000 ];

/** Matrix of size: 400 x 4 (row major format) */
real_t R1[ 1600 ];

/** Matrix of size: 400 x 14 (row major format) */
real_t R2[ 5600 ];
...
/** Matrix of size: 50500 x 4 (row major format) */
real_t E[ 202000 ];
