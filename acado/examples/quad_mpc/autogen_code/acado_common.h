...
{
int dummy;
/** Matrix of size: 51 x 10 (row major format)
 * 
...
/** Matrix of size: 700 x 14 (row major format) */
real_t W[ 9800 ];
...
/** Matrix of size: 500 x 10 (row major format) */
real_t evGx[ 5000 ];

/** Matrix of size: 500 x 4 (row major format) */
real_t evGu[ 2000 ];
...
/** Matrix of size: 500 x 14 (row major format) */
real_t Q2[ 7000 ];
...
/** Matrix of size: 12750 x 4 (row major format) */
real_t E[ 51000 ];
